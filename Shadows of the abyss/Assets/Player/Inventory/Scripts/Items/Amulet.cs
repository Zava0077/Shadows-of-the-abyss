...
public class Amulet : Jewelery
{
    ...
    void Awake()
    {
        ...
        gameObject.GetComponent<Slot>().values[39] += manaAdd + maxManaSummand;
        gameObject.GetComponent<Slot>().values[43] += manaPercent + maxManaPercSummand;
        gameObject.GetComponent<Slot>().values[15] += critAdd + criticalChanceSummand;
        //
